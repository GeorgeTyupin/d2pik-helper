...
const TRANSLATIONS = {
  ru: {
    ...
    'setup.h1':               'Добро пожаловать в d2pik',
    'setup.sub':              'Для получения рекомендаций нужен токен Stratz API. Это бесплатно.',
    'setup.token.label':      'Stratz API Token',
    'setup.token.hint':       'Войдите через Steam и скопируйте токен →',
    'setup.token.invalid':    'Неверный формат токена. Токен должен быть JWT (три части через точку).',
    'setup.token.placeholder':'Вставьте токен сюда…',
    'setup.btn':              'Начать',
    'setup.skip':             'Пропустить (ограниченный режим)',
    ...
    'settings.token':         'Stratz API Token',
    'settings.token.hint':    'Используется для получения данных о матчапах героев.',
    'settings.token.saved':   'Сохранено',
    'settings.token.paste':   'Вставить',
    'settings.token.clear':   'Удалить',
  ...
  en: {
    ...
    'setup.h1':               'Welcome to d2pik',
    'setup.sub':              'A Stratz API token is required for pick recommendations. It\'s free.',
    'setup.token.label':      'Stratz API Token',
    'setup.token.hint':       'Sign in with Steam and copy the token →',
    'setup.token.invalid':    'Invalid token format. Token must be a JWT (three dot-separated parts).',
    'setup.token.placeholder':'Paste your token here…',
    'setup.btn':              'Get Started',
    'setup.skip':             'Skip (limited mode)',
    ...
    'settings.token':         'Stratz API Token',
    'settings.token.hint':    'Used to fetch hero matchup data.',
    'settings.token.saved':   'Saved',
    'settings.token.paste':   'Paste',
